    ...
    return (
        <div>
            <div className="input-group mb-3">
                ...
                />
                <button className="btn btn-secondary" onClick={handleAddIngredient}>Add</button>
            </div>
            <div>
            ...
            <div>
                <button className="btn btn-primary mt-3" onClick={handleSearch}>Search Recipes</button>
